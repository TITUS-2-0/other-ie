...
This is a TEI port of a [TITUS dataset](http://titus.uni-frankfurt.de/texte/etcs/alban/blanchus/blanc.htm).

* URL: https://github.com/TITUS-2-0/other-ie/tree/main/drafts/blanc/
* version: unreleased
* date: 2026-01-15

## Citation
```text
Digital version of Dictionarium Latino-Epiroticum by Franciscus Blanchus (draft version). By: Michiel de Vaan, Jost Gippert, Florian Matter. In: Carling, Gerd & Jost Gippert (2025). TITUS 2.0. Frankfurt: Goethe University. (URL: https://github.com/TITUS-2-0/other-ie/tree/main/drafts/blanc/, visited on <insert date>)
```
